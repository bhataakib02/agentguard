...
export default function PlatformDashboardPage() {
  ...
  return (
    <div className="space-y-5 text-[#1F1F1F]">
      ...
      {/* 5. MAIN ROW 3: System Health + Quick Actions + Organization Context */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        {/* System Health Indicators (4 cols) */}
        <div className="lg:col-span-4 bg-white border border-[#E2E8F0] rounded-[10px] p-4 space-y-3 shadow-xs">
          <div className="flex items-center justify-between">
          ...
          <div className="grid grid-cols-2 gap-3 text-[11px]">
            ...
            <div className="flex items-center justify-between p-2 bg-[#F8FAFC] rounded-[6px] border border-[#E2E8F0]">
              <div className="flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-full bg-[#2E9D50] animate-pulse" />
                <span className="font-bold text-[#1E293B]">Report Engine</span>
              </div>
              <span className="text-[9px] font-bold text-[#2E9D50] font-mono">Operational</span>
            </div>
        ...
        <div className="lg:col-span-5 bg-white border border-[#E2E8F0] rounded-[10px] p-4 space-y-3 shadow-xs">
          ...
          <div className="grid grid-cols-4 sm:grid-cols-7 gap-2.5">
            ...
            >
              ...
              <span className="text-[9px] font-bold text-[#1E293B] group-hover:text-[#2E9D50] leading-tight">Create Org</span>
            </button>
            ...
            >
              ...
              <span className="text-[9px] font-bold text-[#1E293B] group-hover:text-[#2E9D50] leading-tight">Create Agent</span>
            </Link>
            ...
            <Link
              ...
              className="p-2.5 bg-[#F8FAFC] border border-[#CBD5E1] rounded-[8px] hover:bg-[#EAF7EE] hover:border-[#2E9D50] transition-all flex flex-col items-center text-center space-y-1 group"
            >
              <FileText className="w-4 h-4 text-[#2E9D50]" />
              <span className="text-[9px] font-bold text-[#1E293B] group-hover:text-[#2E9D50] leading-tight">Generate Report</span>
            </Link>
            ...
            >
              ...
              <span className="text-[9px] font-bold text-[#1E293B] group-hover:text-[#2E9D50] leading-tight">Audit Logs</span>
            </Link>
        ...
        {/* Organization Context Card (3 cols) */}
        <div className="lg:col-span-3 bg-white border border-[#E2E8F0] rounded-[10px] p-4 space-y-3 shadow-xs flex flex-col justify-between">
          <div>
            <h3 className="font-bold text-[#0F172A] text-[15px]">Organization Context</h3>
            <p className="text-[11px] text-[#64748B]">Switch Organization Context</p>
          </div>
          ...
          <div className="space-y-2">
            <div className="relative">
              <select
                value={selectedOrgScope}
                onChange={(e) => handleOrgScopeChange(e.target.value)}
                className="w-full bg-[#F8FAFC] border border-[#CBD5E1] text-[#1E293B] text-[11px] font-bold rounded-[6px] px-3 py-2 outline-none focus:border-[#2E9D50] cursor-pointer appearance-none"
              >
                <option value="ALL">All Organizations (Global)</option>
                {organizations.map((org) => (
                  <option key={org.id} value={org.id}>{org.name}</option>
              ...
              <ChevronDown className="w-3.5 h-3.5 text-[#64748B] absolute right-3 top-3 pointer-events-none" />
            </div>

            <button
              onClick={() => handleOrgScopeChange(selectedOrgScope)}
              className="w-full py-2 bg-[#173B25] hover:bg-[#237A3C] text-white text-[11px] font-bold rounded-[6px] transition-colors"
            >
              Enter Context
            </button>
          </div>
          ...
          <div className="pt-2 border-t border-[#F1F5F9] flex items-center justify-between text-[10px]">
            <span className="text-[#64748B]">Current Scope:</span>
            <span className="px-2 py-0.5 rounded font-bold uppercase bg-[#EAF7EE] text-[#2E9D50] border border-[#2E9D50]/30 font-mono">
              {activeScopeLabel}
            </span>
          </div>
        </div>
