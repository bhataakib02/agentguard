...
export default function PlatformLayout({ children }: { children: React.ReactNode }) {
  ...
  const navPlatform = [
    ...
    { label: "System Health", href: "/platform/system", icon: Server },
  ...
  return (
    <div className="min-h-screen bg-[#0A0D14] text-[#E1E7F0] flex flex-col lg:flex-row font-sans selection:bg-[#2E9D50] selection:text-white">
      {/* Mobile Top Header */}
      ...
      >
        ...
        <div className="p-4 border-b border-[#1E2638] flex items-center gap-3">
          ...
          <div className="overflow-hidden">
            <h1 className="text-[15px] font-bold text-white leading-none tracking-tight">AGENTGUARD</h1>
        ...
        <div className="p-4 border-t border-[#1E2638] bg-[#0A0D14] space-y-3">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-[8px] bg-[#173B25] border border-[#2E9D50] text-[#2E9D50] font-bold flex items-center justify-center text-[12px] shadow-sm">
              SA
            </div>
            <div className="overflow-hidden">
              <span className="font-bold text-white text-[12px] block truncate">SUPER_ADMIN</span>
              <span className="text-[10px] text-[#64748B] block truncate">Platform Administrator</span>
            </div>
          </div>

          <div className="flex items-center justify-between text-[10px] pt-1">
            <span className="font-bold text-[#2E9D50] bg-[#173B25] px-2 py-0.5 rounded border border-[#2E9D50]/30 font-mono">
              Global Access
            </span>
            <button
              onClick={() => logout()}
      ...
      <main className="flex-1 lg:ml-64 min-h-screen flex flex-col overflow-x-hidden">
        ...
        <header className="bg-[#0F131D] border-b border-[#1E2638] px-6 py-4 flex flex-col md:flex-row md:items-center justify-between gap-4 sticky top-0 z-30 shadow-sm">
          ...
          <div>
            <div className="flex items-center gap-3">
              <h1 className="text-[20px] font-bold text-white tracking-tight">Platform Control Center</h1>
            ...
            <p className="text-[12px] text-[#64748B] mt-0.5">Global Platform Administration</p>
          </div>

          {/* Header Controls: Search, Notifs, Profile */}
          <div className="flex items-center gap-4 w-full md:w-auto justify-between md:justify-end">
            ...
            <div className="relative flex-1 md:w-80">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search organizations, users, agents, licenses..."
                  value={searchQuery}
                  onChange={(e) => handleSearch(e.target.value)}
                  onFocus={() => searchQuery.length >= 2 && setShowSearchDropdown(true)}
                  className="w-full pl-9 pr-4 py-1.5 bg-[#161C2A] border border-[#232F48] rounded-[8px] text-[12px] text-white placeholder-[#64748B] outline-none focus:border-[#2E9D50] transition-colors"
                />
              </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-[#2E9D50] text-white text-[9px] font-bold flex items-center justify-center border border-[#0F131D]">
                  9+
                </span>
              </button>
                ...
                <div className="absolute right-0 mt-2 w-72 bg-[#121722] border border-[#1E2638] rounded-[10px] shadow-2xl p-3 z-50 space-y-2 text-[12px]">
                  ...
                  <div className="space-y-2 max-h-60 overflow-y-auto">
                    ...
                    <div className="p-2 bg-[#1A2234] rounded-[6px] border border-[#232F48] space-y-0.5">
                      ...
                      <p className="text-[11px] text-[#94A3B8]">Critical risk flag evaluated for Nexa Agent-019.</p>
                    </div>
                  </div>
                </div>
              )}
